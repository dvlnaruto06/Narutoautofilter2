...
BOT_TOKEN = environ.get('BOT_TOKEN', "7614723131:AAFp6O-GUPVh5gHvL1AYo70d9THCZ13S1wM")

# Bot settings
CACHE_TIME = int(environ.get('CACHE_TIME', 300))
USE_CAPTION_FILTER = bool(environ.get('USE_CAPTION_FILTER', True))

PICS = (environ.get('PICS', 'https://i.imgur.com/oke0RWH.jpeg')).split() #SAMPLE PIC
NOR_IMG = environ.get("NOR_IMG", "https://i.imgur.com/oke0RWH.jpeg")
...
SUBSCRIPTION = (environ.get('SUBSCRIPTION', 'https://i.imgur.com/EenjB2D.jpeg'))
...
STREAM_API = (environ.get('STREAM_API', '6ee2669987a74250f2f12141d24982f3b62f0407'))
STREAMHTO = (environ.get('STREAMHTO', 'https://t.me/moviehub4u_update/28'))

# Admins, Channels & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6964203412 1886258592').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002153653982').split()] #Channel id for auto indexing ( make sure bot is admin )
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '').split()]
AUTH_USERS = (auth_users + ADMINS) if auth_users else []
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '').split()]
auth_channel = environ.get('AUTH_CHANNEL', '-1002282783745') #Channel / Group Id for force sub ( make sure bot is admin )
...
reqst_channel = environ.get('REQST_CHANNEL_ID', '-1002512459420') # request channel id ( make sure bot is admin )
...
SHORTLINK_API = environ.get('SHORTLINK_API', '6ee2669987a74250f2f12141d24982f3b62f0407')
...
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/moviehub4u_update/28') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', True))
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : ultroidxTeam')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002512459420')) #Log channel id ( make sure bot is admin )
